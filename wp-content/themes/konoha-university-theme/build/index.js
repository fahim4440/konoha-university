...
class Like {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".like-box").on("click", this.click_button_dispatcher.bind(this));
  }
...
class MyNotes {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".delete-note", this.delete_note);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".edit-note", this.edit_note.bind(this));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".update-note", this.update_note.bind(this));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".submit-note").on("click", this.create_note.bind(this));
  }
...
class Search {
  ...
  constructor() {
    ...
    this.searchResultsDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay__results");
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keydown", this.keyDispatcher.bind(this));
      ...
      this.searchResultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.programs.length ? ' <ul class="link-list min-list">' : `<p>No program found <a href="${universityData.root_url}/programs">View all programs</a></p>`}
                    ...
                    <div class="one-third">
                        ...
                        ${results.events.length ? '' : `<p>No event found <a href="${universityData.root_url}/events">View all upcoming events</a></p>`}
  ...
  keyDispatcher(e) {
    if (e.keyCode == 81 && this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus')) {
      this.closeOverlay();
    }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkkonoha_university_theme"] = self["webpackChunkkonoha_university_theme"] || [];
